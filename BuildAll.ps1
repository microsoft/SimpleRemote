...
dotnet publish -o $OUTDIR/SimpleRemoteServer-arm64 -f net6 -r win10-arm64 -c Release | Out-Null
dotnet publish -o $OUTDIR/SimpleRemoteServer-x64 -f net6 -r win10-x64 -c Release | Out-Null
